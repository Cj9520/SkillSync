...
const Upload = () => {
    ...
    const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file }: { companyName: string, jobTitle: string, jobDescription: string, file: File  }) => {
        ...
        try {
            // Upload the PDF file as is first
            ...
            // Skip conversion and use PDF directly
            setStatusText('Using PDF directly...');
            const directPdfUsed = true;
            ...
            const data = {
                id: uuid,
                resumePath: uploadedFile.path,  // PDF file path
                imagePath: uploadedFile.path,   // Use same PDF for preview
                companyName, jobTitle, jobDescription,
                feedback: '',
                isPdfDirect: directPdfUsed      // Flag to use PDF directly
            }
