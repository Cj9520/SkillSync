...
const Upload = () => {
    ...
    const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file }: { companyName: string, jobTitle: string, jobDescription: string, file: File  }) => {
        ...
        try {
            ...
            if (!imageFile.file) {
                console.log('Primary PDF conversion failed, trying fallback method...');
                setStatusText('Trying alternative conversion method...');
                imageFile = await convertPdfToImageFallback(file);
            }
